...
// ddlx volatile uint32_t gpio_irq_count=0;
...
extern uint32_t uart0_irq_count, uart0_rbuf, uart0_tbuf;
volatile uint32_t consoleUART = 0x44E09000;    // SOC_UART_0_REGS;
...
extern void rtc_irq();
extern uint32_t rtc_irq_count, year, month, day, hour, min, sec;
...
extern void DMACompletionIsr(void);
extern void DMACCErrorIsr(void);
